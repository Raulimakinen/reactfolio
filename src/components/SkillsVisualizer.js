  ...
  const skills = {
    tech: {
      ...
      items: [
        ...
        "Olio-ohjelmointi, modulaariset sovellukset, tiedostojen välinen kommunikointi",
        "Backend: Node.js, Express, Python",
        "Tietokannat: MongoDB, SQL",
        "Mobiilisovellukset: React Native alkeet",
        "Mobiilisovellukset: Expo framework",
        "Mobiilisovellukset: Android Studio",
    ...
    organization: {
      ...
      items: [
        ...
        "Viestintäkäytäntöjen perustaminen",
        "(Teams) Tiimirakenteen uudelleenorganisointi eri vuosiluokille soveltuvaksi",
    ...
    soft: {
      ...
      items: [
        "Projektinhallinta ja vahvat tiimityötaidot",
        ...
        "Vahvat dialogi- ja asiakastyötaidot",
      ],
